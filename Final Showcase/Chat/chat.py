...
def main():
    ...
    response_length = input("How long would you like the responses to be?\n")
    end_program = False
                ...
                if user_input:
                    ...
                    if "bye" in user_input.lower() or "exit" in user_input.lower():
                        ...
                        system_data = [
                            ...
                            {"role": "system", "content": f"you can now only be a {bot_type} with {response_length} responses "},
                        ...
                        myobj = gTTS(text=assistant_response, lang="en", slow=False)
